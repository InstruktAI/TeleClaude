...
async def test_workflow_pending_to_done_with_dependencies():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        dep_state = yaml.safe_load(dep_state_path.read_text())
        dep_state["dor"] = {"score": 8}
        dep_state_path.write_text(yaml.dump(dep_state))
        ...
        main_state = yaml.safe_load(main_state_path.read_text())
        main_state["dor"] = {"score": 8}
        main_state_path.write_text(yaml.dump(main_state))
