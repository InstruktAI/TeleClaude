...
# Load modular init steps
source "$INSTALL_DIR/bin/init/setup_mcp_config.sh"
source "$INSTALL_DIR/bin/init/setup_agent_hooks.sh"
source "$INSTALL_DIR/bin/init/link_shared_scripts.sh"
