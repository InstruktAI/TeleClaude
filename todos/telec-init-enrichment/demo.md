...
<!-- Blocks are validated by `telec todo demo validate telec-init-enrichment` (structural check) during build. -->
<!-- Execution (`telec todo demo run telec-init-enrichment`) happens on main after merge. -->
