...
<!-- Blocks are validated by `telec todo demo validate chartest-events-cartridges` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-events-cartridges`) happens on main after merge. -->
