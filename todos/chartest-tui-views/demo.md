...
<!-- Blocks are validated by `telec todo demo validate chartest-tui-views` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-tui-views`) happens on main after merge. -->
