...
<!-- Blocks are validated by `telec todo demo validate chartest-core-adapter-client` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-adapter-client`) happens on main after merge. -->
