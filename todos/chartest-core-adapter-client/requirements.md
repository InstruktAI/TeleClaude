# Requirements: chartest-core-adapter-client

Characterization tests for adapter client.
...
- `teleclaude/core/adapter_client/_channels.py`
- `teleclaude/core/adapter_client/_client.py`
- `teleclaude/core/adapter_client/_output.py`
- `teleclaude/core/adapter_client/_remote.py`
