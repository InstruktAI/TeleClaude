...
<!-- Blocks are validated by `telec todo demo validate tso-validate` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-validate`) happens on main after merge. -->
