...
<!-- Blocks are validated by `telec todo demo validate tso-hooks` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-hooks`) happens on main after merge. -->
