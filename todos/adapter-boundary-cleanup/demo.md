# Demo: adapter-boundary-cleanup

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate adapter-boundary-cleanup` (structural check) during build. -->
<!-- Execution (`telec todo demo run adapter-boundary-cleanup`) happens on main after merge. -->
