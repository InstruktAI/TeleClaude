...
<!-- Blocks are validated by `telec todo demo validate chartest-core-tmux` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-tmux`) happens on main after merge. -->
