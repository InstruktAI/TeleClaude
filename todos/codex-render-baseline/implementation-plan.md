# Implementation Plan: codex-render-baseline
...
**File:** `todos/codex-render-baseline/demo.md`
...
- Validate the artifact once with:
  ```bash
  telec todo demo validate codex-render-baseline
  ```
...
**Verification:** `telec todo demo validate codex-render-baseline` exits 0 after
...
Demo artifact coverage: T11 keeps `todos/codex-render-baseline/demo.md` executable
...
- `todos/codex-render-baseline/demo.md`
