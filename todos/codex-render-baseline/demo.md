...
<!-- Blocks are validated by `telec todo demo validate codex-render-baseline` (structural check) during build. -->
<!-- Execution (`telec todo demo run codex-render-baseline`) happens on main after merge. -->
