# Demo: session-async-control-lane

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate session-async-control-lane` (structural check) during build. -->
<!-- Execution (`telec todo demo run session-async-control-lane`) happens on main after merge. -->
