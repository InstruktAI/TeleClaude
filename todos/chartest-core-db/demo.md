# Demo: chartest-core-db

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate chartest-core-db` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-db`) happens on main after merge. -->
