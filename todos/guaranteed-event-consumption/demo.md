# Demo: guaranteed-event-consumption

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate guaranteed-event-consumption` (structural check) during build. -->
<!-- Execution (`telec todo demo run guaranteed-event-consumption`) happens on main after merge. -->
