# Demo: event-mesh-distribution

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate event-mesh-distribution` (structural check) during build. -->
<!-- Execution (`telec todo demo run event-mesh-distribution`) happens on main after merge. -->
