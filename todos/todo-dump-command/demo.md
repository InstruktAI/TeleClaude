...
<!-- Blocks are validated by `telec todo demo validate todo-dump-command` (structural check) during build. -->
<!-- Execution (`telec todo demo run todo-dump-command`) happens on main after merge. -->
