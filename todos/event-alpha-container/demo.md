...
<!-- Blocks are validated by `telec todo demo validate event-alpha-container` (structural check) during build. -->
<!-- Execution (`telec todo demo run event-alpha-container`) happens on main after merge. -->
