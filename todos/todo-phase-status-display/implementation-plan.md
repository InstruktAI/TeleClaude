...
- [ ] Replace stale demo steps that mention nonexistent or overly broad verification
  commands with the actual checks for this todo
- [ ] Add executable bash blocks that match the planned verification path:
...
- [ ] Update the guided presentation so it follows the actual phase-detection order
