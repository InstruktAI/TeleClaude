# Demo: community-manager-agent

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate community-manager-agent` (structural check) during build. -->
<!-- Execution (`telec todo demo run community-manager-agent`) happens on main after merge. -->
