# Demo: todo-phase-status-display-2

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate todo-phase-status-display-2` (structural check) during build. -->
<!-- Execution (`telec todo demo run todo-phase-status-display-2`) happens on main after merge. -->
