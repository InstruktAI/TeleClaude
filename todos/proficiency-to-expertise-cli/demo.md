# Demo: proficiency-to-expertise-cli

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate proficiency-to-expertise-cli` (structural check) during build. -->
<!-- Execution (`telec todo demo run proficiency-to-expertise-cli`) happens on main after merge. -->
