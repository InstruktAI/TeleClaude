...
<!-- Blocks are validated by `telec todo demo validate integration-orchestrator-rollout` (structural check) during build. -->
<!-- Execution (`telec todo demo run integration-orchestrator-rollout`) happens on main after merge. -->
