# Demo: ucap-slo-hardening

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate ucap-slo-hardening` (structural check) during build. -->
<!-- Execution (`telec todo demo run ucap-slo-hardening`) happens on main after merge. -->
