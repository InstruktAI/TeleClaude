...
<!-- Blocks are validated by `telec todo demo validate content-dump-command` (structural check) during build. -->
<!-- Execution (`telec todo demo run content-dump-command`) happens on main after merge. -->
