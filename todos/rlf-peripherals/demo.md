...
<!-- Blocks are validated by `telec todo demo validate rlf-peripherals` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-peripherals`) happens on main after merge. -->
