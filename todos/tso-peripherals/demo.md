# Demo: tso-peripherals

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate tso-peripherals` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-peripherals`) happens on main after merge. -->
