...
<!-- Blocks are validated by `telec todo demo validate chartest-tui-animations` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-tui-animations`) happens on main after merge. -->
