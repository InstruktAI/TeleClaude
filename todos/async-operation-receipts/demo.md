...
<!-- Blocks are validated by `telec todo demo validate async-operation-receipts` (structural check) during build. -->
<!-- Execution (`telec todo demo run async-operation-receipts`) happens on main after merge. -->
