# Demo: prepare-phase-tiering-2

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate prepare-phase-tiering-2` (structural check) during build. -->
<!-- Execution (`telec todo demo run prepare-phase-tiering-2`) happens on main after merge. -->
