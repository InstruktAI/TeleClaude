...
<!-- Blocks are validated by `telec todo demo validate rlf-core-data` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-core-data`) happens on main after merge. -->
