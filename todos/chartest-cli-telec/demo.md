# Demo: chartest-cli-telec

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate chartest-cli-telec` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-cli-telec`) happens on main after merge. -->
