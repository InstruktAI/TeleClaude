...
<!-- Blocks are validated by `telec todo demo validate integrate-session-lifecycle-into-next-work` (structural check) during build. -->
<!-- Execution (`telec todo demo run integrate-session-lifecycle-into-next-work`) happens on main after merge. -->
