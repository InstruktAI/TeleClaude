...
<!-- Blocks are validated by `telec todo demo validate chartest-core-cmd-handlers` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-cmd-handlers`) happens on main after merge. -->
