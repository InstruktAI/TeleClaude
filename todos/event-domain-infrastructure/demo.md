...
<!-- Blocks are validated by `telec todo demo validate event-domain-infrastructure` (structural check) during build. -->
<!-- Execution (`telec todo demo run event-domain-infrastructure`) happens on main after merge. -->
