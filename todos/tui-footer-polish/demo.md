...
<!-- Blocks are validated by `telec todo demo validate tui-footer-polish` (structural check) during build. -->
<!-- Execution (`telec todo demo run tui-footer-polish`) happens on main after merge. -->
