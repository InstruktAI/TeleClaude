# Demo: community-governance

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate community-governance` (structural check) during build. -->
<!-- Execution (`telec todo demo run community-governance`) happens on main after merge. -->
