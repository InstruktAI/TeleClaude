...
<!-- Blocks are validated by `telec todo demo validate architecture-alignment-integration-pipeline` (structural check) during build. -->
<!-- Execution (`telec todo demo run architecture-alignment-integration-pipeline`) happens on main after merge. -->
