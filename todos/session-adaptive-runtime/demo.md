# Demo: session-adaptive-runtime

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate session-adaptive-runtime` (structural check) during build. -->
<!-- Execution (`telec todo demo run session-adaptive-runtime`) happens on main after merge. -->
