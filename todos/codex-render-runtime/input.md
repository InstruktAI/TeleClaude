# Input: codex-render-runtime

Split from parent `codex-render-semantic-runtime` — Phase 3 (Render-Aware Runtime),
Phase 4 (Wake-Driven Capture), and Phase 6 (Validation and Documentation).

Depends on: `codex-render-baseline` (replay corpus + immediate fixes must land first).
