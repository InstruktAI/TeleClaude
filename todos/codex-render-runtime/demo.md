# Demo: codex-render-runtime

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate codex-render-runtime` (structural check) during build. -->
<!-- Execution (`telec todo demo run codex-render-runtime`) happens on main after merge. -->
