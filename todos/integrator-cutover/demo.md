...
<!-- Blocks are validated by `telec todo demo validate integrator-cutover` (structural check) during build. -->
<!-- Execution (`telec todo demo run integrator-cutover`) happens on main after merge. -->
