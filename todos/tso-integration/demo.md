# Demo: tso-integration

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate tso-integration` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-integration`) happens on main after merge. -->
