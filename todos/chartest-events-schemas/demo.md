...
<!-- Blocks are validated by `telec todo demo validate chartest-events-schemas` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-events-schemas`) happens on main after merge. -->
