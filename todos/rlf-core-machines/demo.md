...
<!-- Blocks are validated by `telec todo demo validate rlf-core-machines` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-core-machines`) happens on main after merge. -->
