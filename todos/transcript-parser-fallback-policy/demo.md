...
<!-- Blocks are validated by `telec todo demo validate transcript-parser-fallback-policy` (structural check) during build. -->
<!-- Execution (`telec todo demo run transcript-parser-fallback-policy`) happens on main after merge. -->
