...
<!-- Blocks are validated by `telec todo demo validate agent-session-auth` (structural check) during build. -->
<!-- Execution (`telec todo demo run agent-session-auth`) happens on main after merge. -->
