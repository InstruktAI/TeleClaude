...
<!-- Blocks are validated by `telec todo demo validate chartest-api-routes` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-api-routes`) happens on main after merge. -->
