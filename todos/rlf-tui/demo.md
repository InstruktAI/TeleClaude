...
<!-- Blocks are validated by `telec todo demo validate rlf-tui` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-tui`) happens on main after merge. -->
