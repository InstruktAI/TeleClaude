...
<!-- Blocks are validated by `telec todo demo validate chartest-core-next-machine` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-next-machine`) happens on main after merge. -->
