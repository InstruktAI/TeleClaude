...
<!-- Blocks are validated by `telec todo demo validate proficiency-to-expertise` (structural check) during build. -->
<!-- Execution (`telec todo demo run proficiency-to-expertise`) happens on main after merge. -->
