...
<!-- Blocks are validated by `telec todo demo validate event-platform` (structural check) during build. -->
<!-- Execution (`telec todo demo run event-platform`) happens on main after merge. -->
