# Demo: public-website-blog

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate public-website-blog` (structural check) during build. -->
<!-- Execution (`telec todo demo run public-website-blog`) happens on main after merge. -->
