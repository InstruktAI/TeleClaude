...
<!-- Blocks are validated by `telec todo demo validate prepare-pipeline-hardening` (structural check) during build. -->
<!-- Execution (`telec todo demo run prepare-pipeline-hardening`) happens on main after merge. -->
