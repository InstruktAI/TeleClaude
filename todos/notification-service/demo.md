...
<!-- Blocks are validated by `telec todo demo validate notification-service` (structural check) during build. -->
<!-- Execution (`telec todo demo run notification-service`) happens on main after merge. -->
