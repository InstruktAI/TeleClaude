# Requirements: chartest-core-agent-coord

Characterization tests for agent coordinator.
...
- `teleclaude/core/agent_coordinator/_coordinator.py`
- `teleclaude/core/agent_coordinator/_fanout.py`
- `teleclaude/core/agent_coordinator/_helpers.py`
- `teleclaude/core/agent_coordinator/_incremental.py`
