...
<!-- Blocks are validated by `telec todo demo validate chartest-core-agent-coord` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-agent-coord`) happens on main after merge. -->
