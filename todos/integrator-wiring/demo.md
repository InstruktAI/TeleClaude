...
<!-- Blocks are validated by `telec todo demo validate integrator-wiring` (structural check) during build. -->
<!-- Execution (`telec todo demo run integrator-wiring`) happens on main after merge. -->
