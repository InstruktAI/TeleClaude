# Requirements: chartest-memory-mirrors

Characterization tests for memory and mirror systems.
...
- `teleclaude/memory/api_routes.py`
- `teleclaude/memory/migrate_from_claude_mem.py`
- `teleclaude/memory/search.py`
- `teleclaude/memory/store.py`
- `teleclaude/memory/context/builder.py`
- `teleclaude/memory/context/compiler.py`
- `teleclaude/memory/context/renderer.py`
- `teleclaude/mirrors/api_routes.py`
- `teleclaude/mirrors/event_handlers.py`
- `teleclaude/mirrors/generator.py`
- `teleclaude/mirrors/processors.py`
- `teleclaude/mirrors/store.py`
- `teleclaude/mirrors/worker.py`
