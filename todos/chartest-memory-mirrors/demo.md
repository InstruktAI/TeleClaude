...
<!-- Blocks are validated by `telec todo demo validate chartest-memory-mirrors` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-memory-mirrors`) happens on main after merge. -->
