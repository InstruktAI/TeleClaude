# Demo: service-publication

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate service-publication` (structural check) during build. -->
<!-- Execution (`telec todo demo run service-publication`) happens on main after merge. -->
