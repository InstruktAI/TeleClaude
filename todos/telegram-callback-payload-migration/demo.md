...
<!-- Blocks are validated by `telec todo demo validate telegram-callback-payload-migration` (structural check) during build. -->
<!-- Execution (`telec todo demo run telegram-callback-payload-migration`) happens on main after merge. -->
