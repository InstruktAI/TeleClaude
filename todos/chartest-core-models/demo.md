...
<!-- Blocks are validated by `telec todo demo validate chartest-core-models` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-models`) happens on main after merge. -->
