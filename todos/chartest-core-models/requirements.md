# Requirements: chartest-core-models

Characterization tests for core models.
...
- `teleclaude/core/models/_adapter.py`
- `teleclaude/core/models/_context.py`
- `teleclaude/core/models/_session.py`
- `teleclaude/core/models/_snapshot.py`
