# Demo: test-suite-overhaul

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate test-suite-overhaul` (structural check) during build. -->
<!-- Execution (`telec todo demo run test-suite-overhaul`) happens on main after merge. -->
