...
<!-- Blocks are validated by `telec todo demo validate chartest-core-integration` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-integration`) happens on main after merge. -->
