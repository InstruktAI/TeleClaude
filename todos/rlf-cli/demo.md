...
<!-- Blocks are validated by `telec todo demo validate rlf-cli` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-cli`) happens on main after merge. -->
