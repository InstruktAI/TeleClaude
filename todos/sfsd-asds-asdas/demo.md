# Demo: sfsd-asds-asdas

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate sfsd-asds-asdas` (structural check) during build. -->
<!-- Execution (`telec todo demo run sfsd-asds-asdas`) happens on main after merge. -->
