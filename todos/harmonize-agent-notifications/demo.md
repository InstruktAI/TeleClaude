...
<!-- Blocks are validated by `telec todo demo validate harmonize-agent-notifications` (structural check) during build. -->
<!-- Execution (`telec todo demo run harmonize-agent-notifications`) happens on main after merge. -->
