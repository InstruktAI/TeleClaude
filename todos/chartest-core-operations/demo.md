...
<!-- Blocks are validated by `telec todo demo validate chartest-core-operations` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-operations`) happens on main after merge. -->
