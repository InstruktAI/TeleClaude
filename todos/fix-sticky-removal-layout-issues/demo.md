...
<!-- Blocks are validated by `telec todo demo validate fix-sticky-removal-layout-issues` (structural check) during build. -->
<!-- Execution (`telec todo demo run fix-sticky-removal-layout-issues`) happens on main after merge. -->
