...
<!-- Blocks are validated by `telec todo demo validate integration-event-chain-phase2` (structural check) during build. -->
<!-- Execution (`telec todo demo run integration-event-chain-phase2`) happens on main after merge. -->
