...
<!-- Blocks are validated by `telec todo demo validate tso-api` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-api`) happens on main after merge. -->
