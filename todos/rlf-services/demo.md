...
<!-- Blocks are validated by `telec todo demo validate rlf-services` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-services`) happens on main after merge. -->
