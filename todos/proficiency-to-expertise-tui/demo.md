# Demo: proficiency-to-expertise-tui

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate proficiency-to-expertise-tui` (structural check) during build. -->
<!-- Execution (`telec todo demo run proficiency-to-expertise-tui`) happens on main after merge. -->
