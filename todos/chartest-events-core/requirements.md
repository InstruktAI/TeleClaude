# Requirements: chartest-events-core

Characterization tests for event pipeline.
...
- `teleclaude/events/cartridge_loader.py`
- `teleclaude/events/cartridge_manifest.py`
- `teleclaude/events/catalog.py`
- `teleclaude/events/domain_config.py`
- `teleclaude/events/domain_pipeline.py`
- `teleclaude/events/domain_registry.py`
- `teleclaude/events/domain_seeds.py`
- `teleclaude/events/envelope.py`
- `teleclaude/events/personal_pipeline.py`
- `teleclaude/events/pipeline.py`
- `teleclaude/events/processor.py`
- `teleclaude/events/producer.py`
- `teleclaude/events/schema_export.py`
- `teleclaude/events/startup.py`
