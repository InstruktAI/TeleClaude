...
<!-- Blocks are validated by `telec todo demo validate chartest-events-core` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-events-core`) happens on main after merge. -->
