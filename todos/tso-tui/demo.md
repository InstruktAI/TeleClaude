...
<!-- Blocks are validated by `telec todo demo validate tso-tui` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-tui`) happens on main after merge. -->
