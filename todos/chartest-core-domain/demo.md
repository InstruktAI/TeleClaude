...
<!-- Blocks are validated by `telec todo demo validate chartest-core-domain` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-core-domain`) happens on main after merge. -->
