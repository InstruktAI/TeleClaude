...
<!-- Blocks are validated by `telec todo demo validate chartest-adapters-ui-qos` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-adapters-ui-qos`) happens on main after merge. -->
