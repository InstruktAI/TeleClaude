# Input: codex-control-lane

Split from parent `codex-render-semantic-runtime` — Phase 5 (Ephemeral Control Lane).

Depends on: `codex-render-runtime` (needs SessionRuntime actor for the control_queue field).
