# Demo: codex-control-lane

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate codex-control-lane` (structural check) during build. -->
<!-- Execution (`telec todo demo run codex-control-lane`) happens on main after merge. -->
