# Requirements: chartest-cli-misc

Characterization tests for CLI utilities.
...
- `teleclaude/cli/config_cmd.py`
- `teleclaude/cli/config_handlers.py`
- `teleclaude/cli/demo_validation.py`
- `teleclaude/cli/editor.py`
- `teleclaude/cli/models.py`
- `teleclaude/cli/session_auth.py`
- `teleclaude/cli/tool_client.py`
- `teleclaude/cli/watch.py`
