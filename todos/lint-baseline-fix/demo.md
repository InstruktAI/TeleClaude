# Demo: lint-baseline-fix

## Validation

<!-- Bash code blocks that prove the feature works. -->
<!-- Blocks are validated by `telec todo demo validate lint-baseline-fix` (structural check) during build. -->
<!-- Execution (`telec todo demo run lint-baseline-fix`) happens on main after merge. -->
