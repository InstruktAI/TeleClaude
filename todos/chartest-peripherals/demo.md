...
<!-- Blocks are validated by `telec todo demo validate chartest-peripherals` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-peripherals`) happens on main after merge. -->
