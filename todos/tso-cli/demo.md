...
<!-- Blocks are validated by `telec todo demo validate tso-cli` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-cli`) happens on main after merge. -->
