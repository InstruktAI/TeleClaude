...
<!-- Blocks are validated by `telec todo demo validate chartest-tui-engine` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-tui-engine`) happens on main after merge. -->
