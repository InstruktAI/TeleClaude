...
<!-- Blocks are validated by `telec todo demo validate rlf-core-infra` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-core-infra`) happens on main after merge. -->
