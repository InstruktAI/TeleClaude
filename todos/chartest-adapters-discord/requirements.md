# Requirements: chartest-adapters-discord

Characterization tests for Discord adapter.
...
- `teleclaude/adapters/discord/channel_ops.py`
- `teleclaude/adapters/discord/gateway_handlers.py`
- `teleclaude/adapters/discord/infra.py`
- `teleclaude/adapters/discord/input_handlers.py`
- `teleclaude/adapters/discord/message_ops.py`
- `teleclaude/adapters/discord/provisioning.py`
- `teleclaude/adapters/discord/relay_ops.py`
- `teleclaude/adapters/discord/session_launcher.py`
- `teleclaude/adapters/discord/team_channels.py`
