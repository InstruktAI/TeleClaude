...
<!-- Blocks are validated by `telec todo demo validate chartest-adapters-discord` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-adapters-discord`) happens on main after merge. -->
