...
<!-- Blocks are validated by `telec todo demo validate cli-knowledge-commands` (structural check) during build. -->
<!-- Execution (`telec todo demo run cli-knowledge-commands`) happens on main after merge. -->
