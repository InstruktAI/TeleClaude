...
<!-- Blocks are validated by `telec todo demo validate mesh-trust-model` (structural check) during build. -->
<!-- Execution (`telec todo demo run mesh-trust-model`) happens on main after merge. -->
