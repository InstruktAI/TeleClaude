...
<!-- Blocks are validated by `telec todo demo validate tso-adapters` (structural check) during build. -->
<!-- Execution (`telec todo demo run tso-adapters`) happens on main after merge. -->
