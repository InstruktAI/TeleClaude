...
<!-- Blocks are validated by `telec todo demo validate chartest-hooks` (structural check) during build. -->
<!-- Execution (`telec todo demo run chartest-hooks`) happens on main after merge. -->
