...
<!-- Blocks are validated by `telec todo demo validate event-system-cartridges` (structural check) during build. -->
<!-- Execution (`telec todo demo run event-system-cartridges`) happens on main after merge. -->
