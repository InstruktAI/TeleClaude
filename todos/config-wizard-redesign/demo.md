...
<!-- Blocks are validated by `telec todo demo validate config-wizard-redesign` (structural check) during build. -->
<!-- Execution (`telec todo demo run config-wizard-redesign`) happens on main after merge. -->
