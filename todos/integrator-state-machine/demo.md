...
<!-- Blocks are validated by `telec todo demo validate integrator-state-machine` (structural check) during build. -->
<!-- Execution (`telec todo demo run integrator-state-machine`) happens on main after merge. -->
