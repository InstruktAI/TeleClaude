...
<!-- Blocks are validated by `telec todo demo validate event-domain-pillars` (structural check) during build. -->
<!-- Execution (`telec todo demo run event-domain-pillars`) happens on main after merge. -->
