...
<!-- Blocks are validated by `telec todo demo validate integration-safety-gates` (structural check) during build. -->
<!-- Execution (`telec todo demo run integration-safety-gates`) happens on main after merge. -->
