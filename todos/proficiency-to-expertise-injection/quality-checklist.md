# Quality Checklist: proficiency-to-expertise-injection
...
- [ ] Code committed
- [ ] Demo validated (`telec todo demo validate proficiency-to-expertise-injection` exits 0, or exception noted)
- [ ] Working tree clean
