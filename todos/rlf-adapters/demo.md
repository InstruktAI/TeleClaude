...
<!-- Blocks are validated by `telec todo demo validate rlf-adapters` (structural check) during build. -->
<!-- Execution (`telec todo demo run rlf-adapters`) happens on main after merge. -->
