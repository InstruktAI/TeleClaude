...
<!-- Blocks are validated by `telec todo demo validate integration-events-model` (structural check) during build. -->
<!-- Execution (`telec todo demo run integration-events-model`) happens on main after merge. -->
