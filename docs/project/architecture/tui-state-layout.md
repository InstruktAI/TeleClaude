---
id: project/architecture/tui-state-layout
type: architecture
scope: project
description: State-driven layout model for the Telec TUI sessions and preparation views.
---

# Tui State Layout — Architecture

## Required reads

- @docs/project/architecture/system-overview.md
- @docs/project/architecture/ui-adapter.md
- @docs/project/architecture/tmux-management.md
