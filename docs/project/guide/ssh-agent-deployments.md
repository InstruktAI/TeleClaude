---
id: project/guide/ssh-agent-deployments
type: guide
scope: project
...
The TeleClaude daemon needs to perform git operations (pull, push) on behalf of AI agents. Without persistent SSH agent access, these operations fail or prompt for credentials interactively, which hangs the daemon.
