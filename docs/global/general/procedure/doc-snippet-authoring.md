...
3. Add frontmatter (id, type, scope, description). Set `clearance` if the snippet should be restricted: `admin` for credentials/destructive ops, `public` for public-facing content. Omit for the default `member` level.
