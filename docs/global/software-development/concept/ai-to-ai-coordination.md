...
1.  **Dispatch:** The Initiator AI calls the `telec sessions run` tool.
...
5.  **Monitoring:** The Initiator AI can monitor the Worker's progress with `telec sessions tail <worker_session_id> --thinking --tools`.
