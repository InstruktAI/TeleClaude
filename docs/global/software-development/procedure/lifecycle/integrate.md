---
id: 'software-development/procedure/lifecycle/integrate'
type: 'procedure'
...
- Delivery bookkeeping (roadmap delivered) on repo root, pushed to origin/main.
...
| After commit, before push            | Pushes squash commit from integration worktree.                       |
