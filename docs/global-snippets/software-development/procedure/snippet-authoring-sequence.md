---
description:
  Ten-step sequence for producing cohesive, atomic snippets without losing
  context.
...
10. **Rebuild and validate** — `python ~/.teleclaude/scripts/build_snippet_index.py` then `python ~/.teleclaude/scripts/sync_snippets.py`.
